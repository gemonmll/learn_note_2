...
### 0420 学习记录
1）学习git add 和git commit ，理解git 工作区、暂存区和提交区、理解changes和stage changes， git pr流程、
1) 101 root had板子、111 dji 黑匣子、wifi密码
2) 诊断日志地址：txt-bsp.log 和txt.log 通信日志地址：bin-mcu.log
3) uds 1902 1906服务，通过dkit发送诊断指令
4) 导证书、切换debug模式，正常使用都是debug online模式